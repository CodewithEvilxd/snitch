...
export const FooterMinimal = () => {
  return (
    <footer className="relative z-10 w-full border-t border-neutral-200/70 dark:border-neutral-800/70 bg-white/80 dark:bg-neutral-950/80 backdrop-blur-md py-14 px-6">
